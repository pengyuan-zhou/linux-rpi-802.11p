...
enum mac80211_tx_control_flags {
	...
	IEEE80211_TX_CTL_10MHZ			= BIT(5), /* pengzhou : add for 802.11p */
	IEEE80211_TX_CTL_5MHZ			= BIT(6), /* pengzhou : add for 802.11p */
};
...
enum mac80211_rx_flags {
	...
	RX_FLAG_10MHZ			= BIT(26), /* pengzhou : add for 802.11p */
	RX_FLAG_5MHZ			= BIT(27), /* pengzhou : add for 802.11p */
};
...
enum ieee80211_hw_flags {
	...
	IEEE80211_HW_DOT11OCB_SUPPORTED, /* pengzhou : add for 802.11p */
